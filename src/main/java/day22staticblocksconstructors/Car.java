package day22staticblocksconstructors;
     /*
        Constructor nedir?
        Class'den obje uretmemize yarayan code block'laridir.

        Class olusturdugumuzda Java bize otomatik olarak bir constructor verir.
        Ama bu cionstructor gozle gorulmez, gozle gorulmeyen otomatik olarak Java tarafindan verilen bu constructor'lara
        "default constructor" denir.

        "default constructor"lar "Car(){}"seklindedir.

        Siz kendi constructir'inizi olustudurdugunuzda Java default constructor'i siler.
        ...
        Cevap:            Method ile Constructor farkli yapilardir.
                          ...
                          ii)Method'larin ismi yaptiklara ise gore developer'lar tarafindan belirlenir.
