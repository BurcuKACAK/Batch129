...
public class CoursesRunner {
    public static void main(String[] args) {
        ...
        // Dolayisiya; abstract class'lar eksigi olan kaliplar gibi dusunulebilir.
        //Java eksik kaliplarin object uretmesine musaade etmez.
        //Bu yuzden, "abstract class"lardan object uretilemez.

        //"abstract class"larin constructor 'i vardr ama bu constructor object uretemez haldedir.
