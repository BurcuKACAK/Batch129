...
public class Lists01 {
    public static void main(String[] args) {
        ...
        /*
        "for loop" kurunuz, products listindeki herbir elemanin tum karakterlerini "set method"kullanarak kucuk harfe ceviriniz
        Kullanicidan gelen urun ismini de kucuk harfe ceviriniz
         */
