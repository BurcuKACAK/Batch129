...
public class C01_StringManipulation {
     ...
     */
       ...
       3) \\s   ==> space tum bosluklar space
        ...
        System.out.println("ikiyuzkirk"+40*6);//ikiyuz240
        System.out.println(60+40+"Yuz");//100Yuz

        //Kullanicidan ismini soy ismini aliniz. Kullanici nasil girerse girsin
        // tam isminin buyuk harfle yazilmasini saglayin.
        //Scanner input =new Scanner(System.in);
       // System.out.println("Lutfen Adinizi ve Soyadinizi Yaziniz");
        //String firstName = input.nextLine() , lastName = input.nextLine();//Multiple declaration
       // String allName = firstName.concat(" "+lastName).toUpperCase();
        ...
        //Verilen cumleyi * ile gizleyip 10uncu karakterden sonrasini yazdirin
