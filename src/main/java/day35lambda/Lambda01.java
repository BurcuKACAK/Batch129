    ...
    */
    ...
    public static void printSquareOfOddElements(List<Integer> nums){
        nums.//12 9 131 14 9 10 4 12 15
                ...
                filter(t->t%2!=0).//Burada tek elemanlari aldik
                map(t->t*t).// olan sayilarin karesini aldik =81 17161 81 225 ////map() methodu varolan elemani degistimrek icin kullanilir
