...
public class HashMapMechanism {
    /*
        1)Siz HashMap olusturmak icin "HashMap<String ,Integer> hm = new HashMap<>();" kodunu yazdiginizda
        Java 16 tane "bucket(kova)"olusturur ve bu "bucket"lari 0 dan 15 e kadar indexler
    ...
    // Bir LinkedList'e istedigimiz kadar eleman eklenebilir
    // HashMap'ler her bir LinkedList kullanir
