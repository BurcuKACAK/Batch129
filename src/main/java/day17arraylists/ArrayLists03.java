...
public class ArrayLists03 {
    public static void main(String[] args) {
        ...
        //remove() methodu indeks ile kullanilirsa o index'teki elemani siler.
        //remove() methodu indeks ile kullanilirsa size sildigi elemani verir
        ...
        //Eger eleman List'te yok ise o elemani silemdiginden size false der
